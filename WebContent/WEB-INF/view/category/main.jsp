...
<nav class="navbar navbar-default navbar-static-top">
  <div class="container" id="navi_bar">
   	<ul>
		...
		<li id="nav7"><a href="${ctx}/customer.do?cmd=cust_retrieve&page=detail&customerId=${customer.customerId}">${customer.customerName}의 페이지</a></li>
	</ul>
</div>
</nav>

<link rel="stylesheet" href="${css}/customer/category.css" />
<div class="grid-item" id="category">
